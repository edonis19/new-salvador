...
List<DataGridRow> get rows {
  ...
  for (var riga in intervento.righe) {
    if (riga.idRiga != null) {
      ...
      String rigaDescrizione = riga.descrizione ?? '';
      double? qta = riga.qta;
      ...
      rowsIntervento.add(DataGridRow(cells: [
        ...
        DataGridCell<Object>(columnName: 'quantita', value: qta),
         DataGridCell<String>(columnName: 'note', value: rigaDescrizione),
      ...
      rowsMap.add(DataGridRow(
        cells: [
          ...
          DataGridCell<String>(columnName: 'operatore', value: righeOperatore),
          const DataGridCell<String>(columnName: 'dataInserimento', value: ''),
                ...
                child: ElevatedButton(
                  onPressed: () {
                    if (intervento.righe.isNotEmpty) {
                      // Controllo se l'elemento da eliminare è l'ultimo
